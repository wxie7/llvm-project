...
;
; GFX940-LABEL: define i32 @test_atomicrmw_or_0_global_agent(
; GFX940-SAME: ptr addrspace(1) [[PTR:%.*]]) #[[ATTR0]] {
; GFX940-NEXT:    [[RES:%.*]] = atomicrmw or ptr addrspace(1) [[PTR]], i32 0 syncscope("agent") seq_cst, align 4
